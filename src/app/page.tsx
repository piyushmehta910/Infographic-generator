...
import { Zap, Sparkles, Download, Layout, Palette, Image, ArrowRight, Star, Check, Menu, X, Github } from 'lucide-react';

const features = [
  {
    icon: <Sparkles className="w-6 h-6" />,
    title: 'AI-Powered Content',
    description: 'Transform text, ideas, or images into structured infographic content with AI correction and formatting.',
  },
  {
    icon: <Layout className="w-6 h-6" />,
    title: 'Template-Driven Design',
    description: 'Choose from 8+ professional templates. AI generates structured JSON, not HTML — our templates handle the design.',
  },
  {
    icon: <Palette className="w-6 h-6" />,
    title: 'Smart Themes',
    description: 'Auto-selected or manual themes including Light, Dark, Minimal, Glassmorphism, Corporate, and more.',
  },
  {
    icon: <Image className="w-6 h-6" />,
    title: 'Image Analysis',
    description: 'Upload images or paste URLs. AI analyzes content, colors, and layout to generate matching infographics.',
  },
  {
    icon: <Download className="w-6 h-6" />,
    title: 'Export Anywhere',
    description: 'Download as PNG, SVG, PDF, HTML, or JSON. High-resolution exports ready for print or social media.',
  },
  {
    icon: <Zap className="w-6 h-6" />,
    title: 'Multi-Provider AI',
    description: 'Bring your own API key for OpenAI, Gemini, Claude, OpenRouter, or Groq. Your data, your choice.',
  },
];

const templates = [
  { name: 'Modern', desc: 'Clean & minimal', color: 'from-violet-500 to-purple-600' },
  { name: 'Business', desc: 'Corporate & professional', color: 'from-blue-600 to-blue-800' },
  { name: 'Timeline', desc: 'Chronological flow', color: 'from-emerald-500 to-teal-600' },
  { name: 'Comparison', desc: 'Side-by-side', color: 'from-orange-500 to-red-600' },
  { name: 'Technology', desc: 'Tech-forward', color: 'from-cyan-500 to-blue-600' },
  { name: 'Startup', desc: 'Energetic & modern', color: 'from-pink-500 to-rose-600' },
  { name: 'Education', desc: 'Learning-focused', color: 'from-green-500 to-emerald-600' },
  { name: 'Marketing', desc: 'Social-optimized', color: 'from-indigo-500 to-purple-600' },
];

const faqs = [
  { q: 'How does the AI generate infographics?', a: 'AI analyzes your content and returns structured JSON. Our template engine then renders that JSON into a beautiful HTML/CSS infographic. AI never generates HTML directly.' },
  { q: 'Do I need an API key?', a: 'Yes, you bring your own API key from your preferred AI provider (OpenAI, Gemini, Claude, etc.). Keys are stored locally in your browser for security.' },
  { q: 'What formats can I export?', a: 'Export as PNG, SVG, PDF, HTML, or JSON Project. All exports preserve high resolution.' },
  { q: 'Can I edit the infographic after generation?', a: 'Yes! After AI generates the content, you can edit text, fonts, colors, layout, and more in our built-in editor.' },
  { q: 'Is my data secure?', a: 'Your API keys stay in your browser. Content is sent directly to your chosen AI provider. We never store your content on our servers.' },
  { q: 'Can I use my own template?', a: 'Yes! The template system is extensible. You can add custom HTML/CSS templates to the template library.' },
];
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-4">
                ...
                <a href="#templates" className="block text-gray-600 py-2">Templates</a>
                ...
                <div className="p-4">
                  <div className="flex flex-wrap gap-2">
                    {['1:1', '16:9', '4:5'].map((ratio) => (
                      <span key={ratio} className="px-2 py-1 bg-gray-100 rounded text-xs text-gray-600">
                        {ratio}
                      </span>
                    ))}
                  </div>
