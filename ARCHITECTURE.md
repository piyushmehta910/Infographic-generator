...
- **AI services** (`src/services/ai/`):
  - `providers.ts` — the 4 provider implementations (`providerMap`, `SYSTEM_PROMPT`)
...
- Provider abstraction (`providerMap: Record<AIProviderId, AIProvider>`) for OpenRouter/NVIDIA NIM/Groq/Mistral (free-tier + official APIs)
