  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        maxOutput: 65536,
        isFree: true,
        description: "OpenAI's flagship open-weight model at ~500 tokens/sec on Groq LPU.",
      },
      {
        ...
        maxOutput: 65536,
        isFree: true,
        description: "Compact OpenAI open-weight model at ~1000 tokens/sec.",
      },
      {
      ...
      },
      {
        ...
        maxOutput: 131072,
        isFree: true,
        description: "Fast, reliable multi-language content expansion (preview model).",
      },
      {
        id: "qwen/qwen3.8-27b",
        name: "Qwen 3.8 27B (Preview)",
        contextWindow: 131042,
        maxOutput: 16384,
        isFree: true,
        description: "Alibaba's coding-tuned model on Groq LPU (preview model).",
      },
    ],
  },
  {
