...
export function getCanvasStyle(
  ...
  const scale = Math.min(
    800 / aspectRatio.width,
    600 / aspectRatio.height,
    1
  );
  ...
  return {
    ...
    boxShadow: settings.shadow ? `0 ${settings.shadow}px ${settings.shadow * 2}px ${theme.colors.shadow}` : 'none',
...
export function getSpacingValue(spacing: 'compact' | 'comfortable' | 'spacious'): number {
  switch (spacing) {
...
export const BUILT_IN_TEMPLATES: TemplateConfig[] = [
  {
    ...
    placeholders: [
      ...
      { id: 'statistics', type: 'stat', label: 'Statistics', defaultValue: '', required: false },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'business',
    name: 'Business',
    description: 'Professional corporate design for business presentations and reports',
    category: 'business',
    aspectRatios: ['16:9', 'A4-P', 'A4-L', '1:1'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'subtitle', type: 'text', label: 'Subtitle', defaultValue: '{{subtitle}}', required: true },
      { id: 'statistics', type: 'stat', label: 'Key Metrics', defaultValue: '', required: true },
      { id: 'sections', type: 'list', label: 'Sections', defaultValue: '', required: true },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'timeline',
    name: 'Timeline',
    description: 'Chronological layout for history, roadmaps, and project timelines',
    category: 'timeline',
    aspectRatios: ['16:9', 'A4-L', '1:1', '4:5'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'timeline', type: 'timeline', label: 'Timeline Events', defaultValue: '', required: true },
      { id: 'sections', type: 'list', label: 'Additional Content', defaultValue: '', required: false },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'comparison',
    name: 'Comparison',
    description: 'Side-by-side comparison layout for products, features, or concepts',
    category: 'comparison',
    aspectRatios: ['16:9', 'A4-L', '1:1'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'sections', type: 'list', label: 'Comparison Items', defaultValue: '', required: true },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'education',
    name: 'Education',
    description: 'Clean educational layout for learning materials and tutorials',
    category: 'education',
    aspectRatios: ['1:1', '4:5', 'A4-P', 'A4-L'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'subtitle', type: 'text', label: 'Subtitle', defaultValue: '{{subtitle}}', required: true },
      { id: 'sections', type: 'list', label: 'Learning Sections', defaultValue: '', required: true },
      { id: 'statistics', type: 'stat', label: 'Key Facts', defaultValue: '', required: false },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'medical',
    name: 'Medical',
    description: 'Healthcare-focused design for medical information and statistics',
    category: 'medical',
    aspectRatios: ['1:1', '4:5', 'A4-P', 'A4-L'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'statistics', type: 'stat', label: 'Medical Stats', defaultValue: '', required: true },
      { id: 'sections', type: 'list', label: 'Information Sections', defaultValue: '', required: true },
      { id: 'timeline', type: 'timeline', label: 'Timeline', defaultValue: '', required: false },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'technology',
    name: 'Technology',
    description: 'Tech-forward design with modern aesthetics for digital content',
    category: 'technology',
    aspectRatios: ['16:9', '1:1', '9:16', '4:5'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Title', defaultValue: '{{title}}', required: true },
      { id: 'sections', type: 'list', label: 'Tech Sections', defaultValue: '', required: true },
      { id: 'statistics', type: 'stat', label: 'Statistics', defaultValue: '', required: false },
      { id: 'timeline', type: 'timeline', label: 'Timeline', defaultValue: '', required: false },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    ...
    placeholders: [
      { id: 'title', type: 'text', label: 'Company Name', defaultValue: '{{title}}', required: true },
      { id: 'subtitle', type: 'text', label: 'Tagline', defaultValue: '{{subtitle}}', required: true },
      { id: 'statistics', type: 'stat', label: 'Key Metrics', defaultValue: '', required: true },
      { id: 'sections', type: 'list', label: 'Sections', defaultValue: '', required: true },
      { id: 'cta', type: 'cta', label: 'Call to Action', defaultValue: '{{cta}}', required: false },
    ],
  ...
  },
  {
    id: 'marketing',
    name: 'Marketing',
    description: 'Social-optimized design for marketing campaigns and social media',
    category: 'marketing',
    aspectRatios: ['1:1', '4:5', '9:16', '16:9'],
    placeholders: [
      { id: 'title', type: 'text', label: 'Headline', defaultValue: '{{title}}', required: true },
      { id: 'subtitle', type: 'text', label: 'Subheadline', defaultValue: '{{subtitle}}', required: false },
      { id: 'sections', type: 'list', label: 'Sections', defaultValue: '', required: true },
