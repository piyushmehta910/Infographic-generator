        ...
        {content.timeline.length > 0 ? (
          content.timeline.map((event, index) => (
            ...
            >
              ...
              >
                <div style={{ fontSize: '12px', fontWeight: 600, color: theme.colors.accent, marginBottom: '2px' }}>
                  {event.date}
                </div>
          ...
          content.sections.slice(0, 4).map((section, index) => (
            ...
            >
              ...
              >
                <div style={{ fontSize: '15px', fontWeight: 600, color: theme.colors.accent, marginBottom: '4px' }}>
